...
public class Converter {
	...
	public static LiveSports fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(LiveSports obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(LiveSports.class);
		writer = mapper.writerFor(LiveSports.class);
	}
