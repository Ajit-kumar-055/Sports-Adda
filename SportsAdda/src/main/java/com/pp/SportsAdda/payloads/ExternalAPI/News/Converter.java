...
// Import this package:
//
//     import io.quicktypecom.pp.SportsAdda.payloads.ExternalAPI.News.Converter;
//
// Then you can deserialize a JSON string with
//
//     News data = Converter.fromJsonString(jsonString);
...
public class Converter {
	...
	public static News fromJsonString(String json) throws IOException {
		return getObjectReader().readValue(json);
	}

	public static String toJsonString(News obj) throws JsonProcessingException {
	...
	private static void instantiateMapper() {
		...
		reader = mapper.readerFor(News.class);
		writer = mapper.writerFor(News.class);
	}
